...
int ls_pcie_init_ctrl(int busno, enum srds_prtcl dev, struct ls_pcie_info *info)
{
	...
	writel(0x00000001, 0x36008bc);
		...
		writel(0x80000001, 0x3600900);
		writel(0xc0000000, 0x3600918);
		writel(0x00000000, 0x360091c);
		writel(0x00000000, 0x3600904);
		writel(0xc0080000, 0x3600908);
		writel(0x00000001, 0x36008bc);
		writel(0x00000FFF, 0x3601010);
		writel(0x00000000, 0x3601018);
		writel(0x00000000, 0x3601020);
		writel(0x00000000, 0x36008bc);

#endif
#if 0		/*PCIe INBOUND mapping*/
		writel(0x00000001, 0x36008bc); 		
		writel(0x80000003, 0x3600900);
		writel(0xd0000000, 0x3600918);	
		writel(0x00000000, 0x360091c);	
		writel(0x00000000, 0x3600904);		
		writel(0xc0080000, 0x3600908);	
		writel(0x00000000, 0x36008bc);			
...
#endif
#if 0		/*OUTBOUND mapping*/
		for(j = 0;j < 8; j++) {
			writel(1, 0x36008bc);		
			writel(0x00000002 + i, 0x3600900);
			writel(0xffffffff, 0x3600914);
			writel(0x00000000, 0x3600918);
			writel(0x00000000, 0x360091c);
			writel(0x00000000, 0x360090c);
			writel(0x30 + i, 0x3600910);
			writel(0, 0x3600904);
			writel(0x80000000, 0x3600908);
			writel(0,0x36008bc);		
		}
#endif
#if 0		/*CFG_READY bit*/
		writel(0x00000001,0x36c0014);
		printf("\n\tCFG_READY set\n");
#endif

#if 0
#ifdef CONFIG_ISSD
		printf("\nbitdatanall class id and bar conf in uboot\n");

		writel(0x00000000, 0x36807f8);  /*PEX_LUT_PEXLCTRL0*/
		writel(0x00000001, 0x36008bc);
		writel(0x09531957, 0x3600000);
#if 0
//Write two of the below three codes to address specifed has no effect
//but on adding all the three to the register, freezes the system 
//operation at the booting time.
		printf("\n bitwise writing to register\n");
		writeb(0x02,0x3600009); 
		writeb(0x08,0x360000a); 
		writeb(0x01,0x360000b);		
#else
//same as above but using writel
		writel(0x01080200, 0x3600008);
#endif
		writel(0x00000000, 0x36008bc);
		writel(0x00010000, 0x36807f8);  /*PEX_LUT_PEXLCTRL0*/
		writel(0x00000001, 0x36008bc);
		writel(0x09531957, 0x3600000);
#if 0
		writeb(0x02,0x3600009); 
		...
		writeb(0x01,0x360000b);		
#else
		writel(0x02000010, 0x3600008);
#endif		
		writel(0x00000000, 0x36008bc);
		writel(0x80000000, 0x36807f8);  /*PEX_LUT_PEXLCTRL0*/
		writel(0x1FFF, 0x3600010);      /*BAR0 NVMe reg 8KB*/
		writel(0x3FFF, 0x3600014);      /*BAR1 MSIX reg 16KB*/
		writel(0x0,0x3600018);
		writel(0x0,0x3600020);
		writel(0x0,0x3600030);
		writel(0x0,0x360019c);
		writel(0x0,0x36001a0);
		writel(0x0,0x36001a4);
		writel(0x0,0x36001a8);
		writel(0x0,0x36001ac);
		writel(0x0,0x36001b0);
		writel(0x0, 0x36807f8);

		writel(0x80010000, 0x36807f8);  /*PEX_LUT_PEXLCTRL0*/
		writel(0x3FFFFF, 0x3600010);    /*BAR0 4MB*/
		writel(0x3FFF, 0x3600014);      /*BAR1 16KB*/
		writel(0xFFFFFF, 0x3600018);    /*BAR2 16MB*/
		writel(0x0,0x360001c);
		writel(0x0,0x3600020);
		writel(0x0,0x3600030);
		writel(0x0,0x360019c);
		writel(0x0,0x36001a0);
