...
#define CONFIG_SYS_CLK_FREQ		100000000
#define CONFIG_DDR_CLK_FREQ		133333333
#define CONFIG_SYS_I2C_MUX_ADDR         0x77
#define CONFIG_SYS_I2C_CPLD_ADDR        0x35
#define CONFIG_SYS_I2C_CPLD_ISSD_ADDR   0x36
#endif
#endif
...
#define CONFIG_CMD_EEPROM_NVME
#define CONFIG_CMD_RETIMERS
#define CONFIG_CMD_DDRSPD
#define CONFIG_CMD_POWER
#define CONFIG_CMD_TEMP
#define CONFIG_CMD_XFI
#define CONFIG_CMD_CPLD
#endif
 ...
 * MMC
 */
#if defined (CONFIG_MMC) && !defined (CONFIG_ISSD)
...
#define CONFIG_EXTRA_ENV_SETTINGS		\
	...
	"bootimg=issd\0"			\
	"dtb_start=0x5803A0000\0"	\
	"dtb_load=0x80000000\0"		\
	"dtb_size=0x20000\0"		\
	"kernel_start_inic=0x5803C0000\0"	\
	"kernel_start_issd=0x580C40000\0"	\
	"kernel_load=0xa0000000\0"		\
	"kernel_size=0x880000\0"       
#else
#define CONFIG_EXTRA_ENV_SETTINGS		\
	"hwconfig=fsl_ddr:bank_intlv=auto\0"	\
	"loadaddr=0x80100000\0"			\
