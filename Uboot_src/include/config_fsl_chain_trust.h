...
#else
/* If Nor Boot, then copy bootscript and header to DDR.
 * This is done to keep this step uniform with non-xip sources
 */
...
#endif
#endif
/* For secure boot, since ENV in non-volatile memories is
