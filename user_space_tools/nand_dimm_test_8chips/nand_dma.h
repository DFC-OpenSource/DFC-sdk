...
#include<sys/time.h>
#include"uatomic.h"
/*Uncomment this to enable Interrupt, the interrupt support is added in 03.00.01 iSSD SDK*/
/*#define INTR*/
...
typedef struct nand_cmd_struct {
	...
	uint32_t len3_len2;
	uint32_t oob_LSB;
	uint32_t oob_len_MSB; /*contains MSB of oob in 1st 20 bits and oob-len in next 12 bits*/
